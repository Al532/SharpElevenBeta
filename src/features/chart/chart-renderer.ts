...
type RenderChartSelectorOptions = {
...
type RenderChartSelectionStateOptions = {
...
/**
 * @param {RenderChartTransportOptions} [options]
 * @returns {void}
 */
...
/**
 * @param {RenderChartSelectorOptions} [options]
 * @returns {string | null}
 */
...
/**
 * @param {RenderChartSelectionStateOptions} [options]
 * @returns {void}
 */
