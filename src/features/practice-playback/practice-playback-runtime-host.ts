...
export function createPracticePlaybackRuntimeHost({
  ...
  return requireRuntimeAppAssembly(createRuntimeAppAssembly)({
    ...
    schedulerHelperBindings: {
      ...
      getPlaybackFeelMode: helpers.getPlaybackFeelMode,
      applyPendingPlaybackFeelToggleForCurrentPosition: helpers.applyPendingPlaybackFeelToggleForCurrentPosition,
      applyPendingPlaybackFeelToggleForNextProgression: helpers.applyPendingPlaybackFeelToggleForNextProgression,
