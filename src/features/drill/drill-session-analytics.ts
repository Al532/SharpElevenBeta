 ...
 * @param {(eventName: string, props?: Record<string, unknown>) => void} [options.helpers.trackEvent]
 * @param {() => string} [options.helpers.getCurrentPatternString]
 * @param {(pattern: string) => OneChordSpec} [options.helpers.parseOneChordSpec]
 ...
 * @param {(pattern: string) => PatternAnalysisResult} [options.helpers.analyzePattern]
