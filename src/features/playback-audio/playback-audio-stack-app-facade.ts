...
type PlaybackAudioStackAppFacadeOptions = {
 ...
 */
export function createPlaybackAudioStackAppFacade({
  audioStack = {},
  getCurrentTime = () => 0,
  defaultFadeDuration = 0.25
}: PlaybackAudioStackAppFacadeOptions = {}) {
  ...
  return {
    ...
    touchSampleBuffer: audioRuntime.touchSampleBuffer,
    purgeSampleCategory: audioRuntime.purgeSampleCategory,
    getSampleCacheStats: audioRuntime.getSampleCacheStats,
    ...
    prepareCompingStyleSamples: samplePreload.prepareCompingStyleSamples,
