...
type CreateChartPlaybackPlanOptions = {
...
/**
 * @param {CreateChartDocumentOptions} [options]
...
/**
 * @param {CreateChartPlaybackPlanOptions} [options]
...
}: CreateChartPlaybackPlanOptions = {}) {
