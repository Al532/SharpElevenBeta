...
- app id: `io.github.al532.jazzprogressiontrainer`
- app name: `Jazz Progression Trainer`
- shared web bundle output: [mobile/www](</C:/Users/Alcibiade/Documents/GitHub/JazzProgressionTrainer/mobile/www>)
- Android first, then iOS on the same runtime

## Current status

- Capacitor config is in place in [mobile/capacitor.config.json](</C:/Users/Alcibiade/Documents/GitHub/JazzProgressionTrainer/mobile/capacitor.config.json>).
- The mobile web bundle is produced by [vite.mobile.config.js](</C:/Users/Alcibiade/Documents/GitHub/JazzProgressionTrainer/vite.mobile.config.js>).
- Root scripts now expose the main workflow without changing directory.
- Native platforms are still intentionally absent from version control at this stage.
...
4. In [mobile](</C:/Users/Alcibiade/Documents/GitHub/JazzProgressionTrainer/mobile>), add the Android shell with `npx cap add android`.
5. Sync the latest web bundle into Capacitor with `npm run mobile:sync`.
6. Open the Android project with `npm run mobile:open:android`.
...
- Root shortcuts are available in [package.json](</C:/Users/Alcibiade/Documents/GitHub/JazzProgressionTrainer/package.json>) as `mobile:install`, `mobile:copy`, `mobile:sync`, `mobile:open:android`, and `mobile:open:ios`.
